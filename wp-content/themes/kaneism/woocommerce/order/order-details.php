...
?>
<section class="woocommerce-order-details component--section">
		...
		<tfoot>
			...
			<?php if ( $order->get_customer_note() ) : ?>
				<tr>
					...
					<td data-title="<?php esc_html_e( 'Note:', 'woocommerce' ); ?>"><?php echo wp_kses( nl2br( wptexturize( $order->get_customer_note() ) ), array( 'br' => array() ) ); ?></td>
				</tr>
			<?php endif; ?>
		</tfoot>
	</table>
