 ...
 * @return array
 */
function basecamp_add_cron_intervals( array $schedules ): array {
	$schedules['weekly'] = [
...
add_filter( 'cron_schedules', 'basecamp_add_cron_intervals' );
 ...
 */
function basecamp_schedule_events(): void {
...
add_action( 'after_switch_theme', 'basecamp_schedule_events' );
 ...
 */
function basecamp_unschedule_events(): void {
	wp_clear_scheduled_hook( 'basecamp_daily_maintenance' );

	// Mirror every hook registered in basecamp_schedule_events() above.
}
add_action( 'switch_theme', 'basecamp_unschedule_events' );
 ...
 */
function basecamp_daily_maintenance_callback(): void {
...
add_action( 'basecamp_daily_maintenance', 'basecamp_daily_maintenance_callback' );
