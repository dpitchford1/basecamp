...
<?php if(in_array($_SERVER['REMOTE_ADDR'], array('127.0.0.1', '::1'))) { ?>
    <link rel="stylesheet" href="css/devpilot-drawer.min.css" media="all">
    <link rel="stylesheet" href="css/html-outline.min.css" media="all">
    ...
    <script src="js/working.min.js"></script>
    <script src="js/html-outline.min.js"></script>
    <script>
