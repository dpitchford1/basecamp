...
function template_login_css() {
	wp_enqueue_style( 'template_login_css', get_template_directory_uri() . '/library/css/login.css', array() );
}
...
function template_admin_css() {
  wp_enqueue_style( 'template_admin_css', get_template_directory_uri() . '/library/css/admin.css', array() );
}
...
add_filter( 'admin_footer_text', 'basecamp_custom_admin_footer' );

function basecamp_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="https://studio.bio" target="_blank">studio.bio</a></span>. Built using <a href="https://studio.bio/template" target="_blank">Basecamp</a>.', 'basecamp' );
}
